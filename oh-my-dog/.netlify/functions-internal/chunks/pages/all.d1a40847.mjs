...
${maybeRenderHead($$result)}<div class="lg:flex lg:flex-wrap lg:justify-evenly lg:mx-5">
    ...
    <div class="bg-[var(--main)] w-[50vw] lg:w-[15vw] mx-auto  my-5 rounded-lg flex flex-col justify-center hide hover:scale-110 duration-150 cursor-pointer">
      <img src="/assets/gromming.png" alt="gromming" class="h-16 w-16 p-2 rounded-full bg-blue-400 mx-auto my-5">
...
<!--card 2 -->
<div class="bg-[var(--main)] w-[50vw] lg:w-[15vw] mx-auto  my-5 rounded-lg flex flex-col justify-center hide hover:scale-110 duration-150 cursor-pointer">
  <img src="/assets/vet.png" alt="gromming" class="h-16 w-16 p-2 rounded-full bg-red-400 mx-auto my-5">
...
<!--card 3-->
<div class="bg-[var(--main)] w-[50vw] lg:w-[15vw] mx-auto  my-5 rounded-lg flex flex-col justify-center hide hover:scale-110 duration-150 cursor-pointer">
<img src="/assets/food.png" alt="gromming" class="h-16 w-16 p-2 rounded-full bg-purple-400 mx-auto my-5">
...
<!--card 4-->
<div class="bg-[var(--main)] w-[50vw] lg:w-[15vw] mx-auto  my-5 rounded-lg flex flex-col justify-center hide hover:scale-110 duration-150 cursor-pointer">
<img src="/assets/toys.png" alt="gromming" class="h-16 w-16 p-2 rounded-full bg-orange-400 mx-auto my-5">
...
}, "/home/maicol/Desktop/omd/oh-my-dog/src/components/Cards.astro");
...
<div class="flip-card md:h-[30vh] lg:w-[15vw] cursor-pointer hide">
  <div class="flip-card-inner">
    <div class="flip-card-front bg-[var(--main)] rounded-lg ">
      <img src="/assets/vet1.jpg" alt="Avatar" class="w-[90%] h-[60%] flex justify-center mx-auto rounded-lg mt-5">
...
<div class="flip-card-inner">
  <div class="flip-card-front bg-[var(--main)] rounded-lg ">
    <img src="/assets/vet2.jpg" alt="Avatar" class="w-[90%] h-[60%] flex justify-center mx-auto rounded-lg mt-5">
...
<div class="flip-card md:h-[30vh] lg:w-[15vw] cursor-pointer hide">
  <div class="flip-card-inner">
    <div class="flip-card-front bg-[var(--main)] rounded-lg ">
      <img src="/assets/groomer.jpg" alt="Avatar" class="w-[90%] h-[60%] flex justify-center mx-auto rounded-lg mt-5">
  ...
  <div class="flip-card md:h-[30vh] lg:w-[15vw] cursor-pointer hide">
    <div class="flip-card-inner">
      <div class="flip-card-front bg-[var(--main)] rounded-lg ">
        <img src="/assets/groomer2.jpg" alt="Avatar" class="w-[90%] h-[60%] flex justify-center mx-auto rounded-lg mt-5">
...
}, "/home/maicol/Desktop/omd/oh-my-dog/src/components/FlipCard.astro");
...
}, "/home/maicol/Desktop/omd/oh-my-dog/src/components/Plans.astro");
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead($$result)}<nav class="flex justify-between md:justify-around items-center px-3 bg-[var(--main)] fixed top-0 w-screen z-50 shadow-sm md:h-16">
    ...
    <div class="mt-3 hidden md:block">
        ...
        <!-- menu mobile -->
<div class="md:hidden">  
    ${renderComponent($$result, "MenuMobile", MenuMobile, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/home/maicol/Desktop/omd/oh-my-dog/src/components/MenuMobile", "client:component-export": "default" })}
</div>


</nav>`;
}, "/home/maicol/Desktop/omd/oh-my-dog/src/components/Header.astro");
...
<footer class="flex justify-around p-2 space-x-2 mt-20 lg:mt-28 lg:pt-8">
   ...
   <div>
       <div class="flex space-x-2 items-center hide">
           <img src="/assets/logo.png" alt="logo" class="h-7 w-7 mt-[-10px]">
...
}, "/home/maicol/Desktop/omd/oh-my-dog/src/components/Footer.astro");
...
}, "/home/maicol/Desktop/omd/oh-my-dog/src/layouts/Layout.astro");
...
${renderComponent($$result, "Layout", $$Layout, { "title": "Oh My Dog" }, { "default": () => renderTemplate`${maybeRenderHead($$result)}<div class="loader"></div><main>
	  ...
	  <section class="block lg:flex lg:flex-row-reverse lg:mt-16 lg:justify-center lg:mx-auto">
		...
		<div class="flex mx-10 mt-10 lg:mt-1">
			<img src="/assets/hero.png" alt="hero" class="w-[80vw] lg:w-auto mx-auto h-[50vh] hide">
		</div>
		...
		<div>
			...
			<ul class="mt-1 ml-8 hide">
				<li class="flex space-x-3 my-2">
					<img src="/assets/logo.png" alt="logo" class="h-5 w-5 rotate-12">
		...
		<div class="flex mx-2 mt-5">
			<img src="/assets/hero2.png" alt="hero" class="mx-auto lg:w-[25vw] hide">
		</div>
		...
		<div class="flex mx-2 mt-5">
			<img src="/assets/hero3.png" alt="hero" class="mx-auto md:w-[25vw] hide">
		</div>


	  </section>${renderComponent($$result, "ScrollTop", ScrollToTop, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/home/maicol/Desktop/omd/oh-my-dog/src/components/ScrollTop", "client:component-export": "default" })}` })}`;
}, "/home/maicol/Desktop/omd/oh-my-dog/src/pages/index.astro");

const $$file$2 = "/home/maicol/Desktop/omd/oh-my-dog/src/pages/index.astro";
const $$url$2 = "";
...
${renderComponent($$result, "Layout", $$Layout, { "title": "Oh My Dog | Contact" }, { "default": () => renderTemplate`${maybeRenderHead($$result)}<div class="loader"></div><main>
        ...
        <section>
          <div class="flex mx-10 mt-10">
            ${renderComponent($$result, "Goback", Goback, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/home/maicol/Desktop/omd/oh-my-dog/src/components/Goback", "client:component-export": "default" })}
              <img src="/assets/hero.png" alt="hero" class=" mx-auto h-[20vh] hide lg:mt-10">
          </div>
...
}, "/home/maicol/Desktop/omd/oh-my-dog/src/pages/contact.astro");

const $$file$1 = "/home/maicol/Desktop/omd/oh-my-dog/src/pages/contact.astro";
const $$url$1 = "/contact";
...
${renderComponent($$result, "Layout", $$Layout, { "title": "Oh My Dog | error" }, { "default": () => renderTemplate`${maybeRenderHead($$result)}<div class="loader"></div><section class="mt-10">
        <div class="flex mx-10 mt-10">
			<img src="/assets/hero.png" alt="hero" class=" mx-auto lg:mt-10 h-[30vh] hide">
		</div>
       <div class="flex justify-center">
        <h1 class="text-2xl mt-28 lg:mt-10 text-[var(--dark)]">Page Not Found</h1>
       </div>
    <div class="flex justify-center mt-10 pb-10">
        <a href="/oh-my-dog/" class="p-2 bg-red-400 hover:bg-red-600 hover:scale-110 duration-200 text-white rounded-lg">Go back to the main page</a>
    </div>
    </section>` })}`;
}, "/home/maicol/Desktop/omd/oh-my-dog/src/pages/404.astro");

const $$file = "/home/maicol/Desktop/omd/oh-my-dog/src/pages/404.astro";
const $$url = "/404";
